...
from Lesson7.LMparser.items import LMParserItem
...
class LMSpider(scrapy.Spider):
    ...
    def __init__(self, query):
        ...
        self.start_urls = [
            f'https://ekaterinburg.leroymerlin.ru/search/?q={query}family=00b9b5a0-faeb-11e9-810b-878d0b27ea5b&suggest=true']
